...
class IntroScreenEfficiencyView: UIView, CardTheme {
    // Private vars
    ...
    private lazy var titleImageViewPage1: UIImageView = {
        let imgView = UIImageView(image: UIImage(named: "tour-Efficiency"))
    ...
    private lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = Strings.CardTitleEfficiency
    ...
    private lazy var subTitleLabelPage1: UILabel = {
        ...
        let label = UILabel()
        label.text = Strings.CardTextEfficiency
        label.textColor = fxTextThemeColour
