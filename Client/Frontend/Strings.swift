...
extension Strings {
    ...
    public static let AppMenuNightMode = NSLocalizedString("Menu.NightModeTurnOn.Label", value: "Toggle light/dark theme", comment: "Label for the button, displayed in the menu, turns on night mode.")
