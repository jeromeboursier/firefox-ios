...
extension BlockerStatus {
    var image: UIImage {
        ...
        case .blocking, .noBlockedURLs:
            return UIImage(imageLiteralResourceName: "qwant_vip_on")
        case .safelisted:
            return UIImage(imageLiteralResourceName: "qwant_vip_off")
        case .disabled:
            return UIImage(imageLiteralResourceName: "qwant_vip_disabled")
        }
    }
...
class QwantVIP {
    var safelistedDomains = QwantVIPSafelistedDomains()
    ...
    private init() {
        ...
        ruleStore?.compileContentRuleList(
            ...
            encodedContentRuleList: blockImages
        ) { rule, error in
        ...
        QwantVIPStatsBlocklistChecker.shared.startup()
    ...
    func setupTrackingProtection(forTab tab: ContentBlockerTab, isEnabled: Bool, rules: [QwantBlocklistFileName]) {
        ...
        QwantVIPStatsBlocklistChecker.shared.reload(blocklists: rules)
