...
class SettingsCoordinator: BaseCoordinator,
    ...
    private func getSettingsViewController(settingsSection section: Route.SettingsSection) -> UIViewController? {
        ...
        case .contentBlocker:
            let contentBlockerVC = QwantVIPSettingsViewController(windowUUID: windowUUID,
                                                                  prefs: profile.prefs,
    ...
    func pressedContentBlocker() {
        let viewController = QwantVIPSettingsViewController(windowUUID: windowUUID, prefs: profile.prefs)
