...
class QwantVIPMenuVC: QwantVIPBaseVC {
    ...
    private lazy var localProtectionActivationButton: UIButton = {
    ...
    private var viewModel: QwantVIPMenuVM
    ...
    private func setupLocalProtectionView() {
        ...
        localProtectionHeaderContainer.addSubviews(
            localProtectionShieldImage,
            localProtectionShieldCounterLabel,
            localProtectionTitleLabel,
            localProtectionDetailArrow)
        ...
        localProtectionActivatedContainer.addSubviews(
            localProtectionSubtitleLabel,
            localProtectionConnectionImage,
            localProtectionConnectionLabel,
            localProtectionSeparatorLine,
            localProtectionLabel,
            localProtectionToggle,
            localProtectionActivityIndicator)
        ...
        localProtectionView.addSubviews(
            localProtectionHeaderContainer,
            localProtectionActivatedContainer,
            localProtectionDeactivatedContainer,
            localProtectionDetailsButton)
        ...
        let localProtectionHeaderContainerConstraints = [
            ...
            localProtectionShieldImage.topAnchor.constraint(
                equalTo: localProtectionHeaderContainer.topAnchor,
            ...
            localProtectionShieldCounterLabel.widthAnchor.constraint(
                equalTo: localProtectionShieldImage.widthAnchor,
                multiplier: 0.75),

            localProtectionTitleLabel.topAnchor.constraint(
                equalTo: localProtectionShieldImage.bottomAnchor,
            ...
            localProtectionTitleLabel.leadingAnchor.constraint(
                greaterThanOrEqualTo: localProtectionHeaderContainer.leadingAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionTitleLabel.bottomAnchor.constraint(
                equalTo: localProtectionHeaderContainer.bottomAnchor,
                constant: QwantUX.Spacing.m),

            localProtectionDetailArrow.trailingAnchor.constraint(
                equalTo: localProtectionView.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            localProtectionDetailArrow.centerYAnchor.constraint(
                equalTo: localProtectionView.centerYAnchor,
                constant: -(QwantUX.Spacing.xs + localProtectionToggle.frame.height + QwantUX.Spacing.xs + 1) / 2)
        ]

        let localProtectionActivatedContainerConstraints = [
            localProtectionActivatedContainer.topAnchor.constraint(
                equalTo: localProtectionHeaderContainer.bottomAnchor,
                constant: QwantUX.Spacing.m),
            ...
            localProtectionSubtitleLabel.topAnchor.constraint(
                equalTo: localProtectionActivatedContainer.topAnchor,
                constant: QwantUX.Spacing.xxxs),
            localProtectionSubtitleLabel.centerXAnchor.constraint(equalTo: localProtectionActivatedContainer.centerXAnchor),
            localProtectionSubtitleLabel.leadingAnchor.constraint(
                greaterThanOrEqualTo: localProtectionActivatedContainer.leadingAnchor,
                constant: QwantUX.Spacing.m),

            localProtectionConnectionLabel.topAnchor.constraint(
                equalTo: localProtectionSubtitleLabel.bottomAnchor,
                constant: QwantUX.Spacing.xxxs),
            localProtectionConnectionLabel.centerXAnchor.constraint(
                equalTo: localProtectionActivatedContainer.centerXAnchor,
                constant: (15 + QwantUX.Spacing.xs) / 2),
            localProtectionConnectionLabel.leadingAnchor.constraint(
                greaterThanOrEqualTo: localProtectionActivatedContainer.leadingAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionConnectionLabel.heightAnchor.constraint(equalToConstant: 15),

            localProtectionConnectionImage.trailingAnchor.constraint(
                equalTo: localProtectionConnectionLabel.leadingAnchor,
                constant: -QwantUX.Spacing.xs),
            ...
            localProtectionSeparatorLine.topAnchor.constraint(
                equalTo: localProtectionConnectionImage.bottomAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionSeparatorLine.leadingAnchor.constraint(
                equalTo: localProtectionActivatedContainer.leadingAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionSeparatorLine.heightAnchor.constraint(equalToConstant: 1),
            localProtectionSeparatorLine.trailingAnchor.constraint(
                equalTo: localProtectionActivatedContainer.trailingAnchor),

            localProtectionLabel.leadingAnchor.constraint(
                equalTo: localProtectionActivatedContainer.leadingAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionLabel.trailingAnchor.constraint(
                greaterThanOrEqualTo: localProtectionToggle.leadingAnchor,
                constant: -QwantUX.Spacing.m),
            localProtectionLabel.centerYAnchor.constraint(equalTo: localProtectionToggle.centerYAnchor),

            localProtectionToggle.topAnchor.constraint(
                equalTo: localProtectionSeparatorLine.bottomAnchor,
                constant: QwantUX.Spacing.xs),
            localProtectionToggle.trailingAnchor.constraint(
                equalTo: localProtectionActivatedContainer.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            localProtectionToggle.bottomAnchor.constraint(
                equalTo: localProtectionActivatedContainer.bottomAnchor,
                constant: -QwantUX.Spacing.xs),
        ...
        let localProtectionDeactivatedContainerConstraints = [
            localProtectionDeactivatedContainer.topAnchor.constraint(
                equalTo: localProtectionHeaderContainer.bottomAnchor,
                constant: QwantUX.Spacing.m),
            ...
            localProtectionActivationButton.topAnchor.constraint(
                equalTo: localProtectionDeactivatedContainer.topAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionActivationButton.heightAnchor.constraint(equalToConstant: 36),
            localProtectionActivationButton.leadingAnchor.constraint(
                equalTo: localProtectionDeactivatedContainer.leadingAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionActivationButton.trailingAnchor.constraint(
                equalTo: localProtectionDeactivatedContainer.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            localProtectionActivationButton.bottomAnchor.constraint(
                equalTo: localProtectionDeactivatedContainer.bottomAnchor,
                constant: -QwantUX.Spacing.m),
        ]
        ...
        constraints.append(contentsOf: [
            ...
            localProtectionView.topAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.topAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionView.leadingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                constant: QwantUX.Spacing.m),
            localProtectionView.trailingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                constant: -QwantUX.Spacing.m),

            localProtectionFooterLabel.topAnchor.constraint(
                equalTo: localProtectionView.bottomAnchor,
                constant: QwantUX.Spacing.xs),
            localProtectionFooterLabel.leadingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                constant: QwantUX.Spacing.xxl),
            localProtectionFooterLabel.trailingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                constant: -QwantUX.Spacing.xxl),
        ])
    ...
    private func setupProtectionLevelView() {
        protectionLevelView.addSubviews(
            protectionLevelDetailsButton,
            protectionLevelTitleLabel,
            protectionLevelSubtitleLabel,
            protectionLevelDetailsArrow)
        contentView.addSubview(protectionLevelView)

        let topAnchor = !viewModel.globalETPIsEnabled ?
        localProtectionView.bottomAnchor : localProtectionFooterLabel.bottomAnchor

        constraints.append(contentsOf: [
            protectionLevelView.topAnchor.constraint(
                equalTo: topAnchor,
                constant: QwantUX.Spacing.xxl),
            protectionLevelView.leadingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                constant: QwantUX.Spacing.m),
            protectionLevelView.trailingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                constant: -QwantUX.Spacing.m),

            protectionLevelTitleLabel.topAnchor.constraint(
                equalTo: protectionLevelView.topAnchor,
                constant: QwantUX.Spacing.s),
            protectionLevelTitleLabel.leadingAnchor.constraint(
                equalTo: protectionLevelView.leadingAnchor,
                constant: QwantUX.Spacing.m),
            protectionLevelTitleLabel.bottomAnchor.constraint(
                equalTo: protectionLevelView.bottomAnchor,
                constant: -QwantUX.Spacing.s),

            protectionLevelSubtitleLabel.centerYAnchor.constraint(equalTo: protectionLevelTitleLabel.centerYAnchor),
            protectionLevelSubtitleLabel.leadingAnchor.constraint(
                greaterThanOrEqualTo: protectionLevelTitleLabel.trailingAnchor,
                constant: QwantUX.Spacing.m),

            protectionLevelDetailsArrow.centerYAnchor.constraint(equalTo: protectionLevelTitleLabel.centerYAnchor),
            protectionLevelDetailsArrow.leadingAnchor.constraint(
                equalTo: protectionLevelSubtitleLabel.trailingAnchor,
                constant: QwantUX.Spacing.s),
            protectionLevelDetailsArrow.trailingAnchor.constraint(
                equalTo: protectionLevelView.trailingAnchor,
                constant: -QwantUX.Spacing.m),
    ...
    private func setupStatisticsView() {
        ...
        constraints.append(contentsOf: [
            statisticsLeftView.topAnchor.constraint(
                equalTo: protectionLevelView.bottomAnchor,
                constant: QwantUX.Spacing.xl),
            statisticsLeftView.leadingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                constant: QwantUX.Spacing.m),
            statisticsLeftView.trailingAnchor.constraint(
                equalTo: contentView.centerXAnchor,
                constant: -QwantUX.Spacing.xxs),

            statisticsLeftTitle.topAnchor.constraint(
                equalTo: statisticsLeftView.topAnchor,
                constant: QwantUX.Spacing.s),
            statisticsLeftTitle.leadingAnchor.constraint(
                equalTo: statisticsLeftView.leadingAnchor,
                constant: QwantUX.Spacing.m),
            statisticsLeftTitle.trailingAnchor.constraint(
                equalTo: statisticsLeftView.trailingAnchor,
                constant: -QwantUX.Spacing.m),

            statisticsLeftValue.topAnchor.constraint(
                equalTo: statisticsLeftTitle.bottomAnchor,
                constant: QwantUX.Spacing.xs),
            statisticsLeftValue.leadingAnchor.constraint(
                equalTo: statisticsLeftView.leadingAnchor,
                constant: QwantUX.Spacing.m),
            statisticsLeftValue.trailingAnchor.constraint(
                greaterThanOrEqualTo: statisticsLeftImage.leadingAnchor,
                constant: QwantUX.Spacing.s),
            statisticsLeftValue.bottomAnchor.constraint(
                equalTo: statisticsLeftView.bottomAnchor,
                constant: -QwantUX.Spacing.s),

            statisticsLeftImage.trailingAnchor.constraint(
                equalTo: statisticsLeftView.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            statisticsLeftImage.bottomAnchor.constraint(
                equalTo: statisticsLeftView.bottomAnchor,
                constant: -QwantUX.Spacing.s),
            ...
            statisticsRightView.topAnchor.constraint(
                equalTo: protectionLevelView.bottomAnchor,
                constant: QwantUX.Spacing.xl),
            statisticsRightView.leadingAnchor.constraint(
                equalTo: contentView.centerXAnchor,
                constant: QwantUX.Spacing.xxs),
            statisticsRightView.trailingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            statisticsRightView.heightAnchor.constraint(equalTo: statisticsRightView.heightAnchor),

            statisticsRightTitle.topAnchor.constraint(
                equalTo: statisticsRightView.topAnchor,
                constant: QwantUX.Spacing.s),
            statisticsRightTitle.leadingAnchor.constraint(
                equalTo: statisticsRightView.leadingAnchor,
                constant: QwantUX.Spacing.m),
            statisticsRightTitle.trailingAnchor.constraint(
                equalTo: statisticsRightView.trailingAnchor,
                constant: -QwantUX.Spacing.m),

            statisticsRightValue.topAnchor.constraint(
                equalTo: statisticsRightTitle.bottomAnchor,
                constant: QwantUX.Spacing.xs),
            statisticsRightValue.leadingAnchor.constraint(
                equalTo: statisticsRightView.leadingAnchor,
                constant: QwantUX.Spacing.m),
            statisticsRightValue.trailingAnchor.constraint(
                greaterThanOrEqualTo: statisticsRightImage.leadingAnchor,
                constant: QwantUX.Spacing.s),
            statisticsRightValue.bottomAnchor.constraint(
                equalTo: statisticsRightView.bottomAnchor,
                constant: -QwantUX.Spacing.s),

            statisticsRightImage.trailingAnchor.constraint(
                equalTo: statisticsRightView.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            statisticsRightImage.bottomAnchor.constraint(
                equalTo: statisticsRightView.bottomAnchor,
                constant: -QwantUX.Spacing.s),
            ...
            statisticsDetailsButton.topAnchor.constraint(
                equalTo: statisticsLeftView.bottomAnchor,
                constant: QwantUX.Spacing.xs),
            statisticsDetailsButton.leadingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                constant: QwantUX.Spacing.m),
            statisticsDetailsButton.trailingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                constant: -QwantUX.Spacing.m)
        ])
    }
    ...
    private func setupInformationView() {
        ...
        constraints.append(contentsOf: [
            informationView.topAnchor.constraint(
                equalTo: statisticsDetailsButton.bottomAnchor,
                constant: QwantUX.Spacing.xl),
            informationView.leadingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                constant: QwantUX.Spacing.m),
            informationView.trailingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            ...
            informationTitleLabel.leadingAnchor.constraint(
                ...
                constant: QwantUX.Spacing.m),
            informationTitleLabel.bottomAnchor.constraint(
            ...
            informationDetailsArrow.leadingAnchor.constraint(
                greaterThanOrEqualTo: informationTitleLabel.trailingAnchor,
                constant: QwantUX.Spacing.s),
            informationDetailsArrow.trailingAnchor.constraint(
        ...
        if !viewModel.mailHelper.canSendMail() {
            constraints.append(informationView.bottomAnchor.constraint(
    ...
    private func setupMailView() {
        ...
        constraints.append(contentsOf: [
            ...
            mailView.leadingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.leadingAnchor,
                constant: QwantUX.Spacing.m),
            mailView.trailingAnchor.constraint(
                equalTo: contentView.safeAreaLayoutGuide.trailingAnchor,
                constant: -QwantUX.Spacing.m),
            mailView.bottomAnchor.constraint(
                lessThanOrEqualTo: contentView.safeAreaLayoutGuide.bottomAnchor,
                constant: -QwantUX.Spacing.m),

            mailTitleLabel.topAnchor.constraint(
                equalTo: mailView.topAnchor,
                constant: QwantUX.Spacing.s),
            mailTitleLabel.leadingAnchor.constraint(
                equalTo: mailView.leadingAnchor,
                constant: QwantUX.Spacing.m),
            mailTitleLabel.bottomAnchor.constraint(
                equalTo: mailView.bottomAnchor,
                constant: -QwantUX.Spacing.s),

            mailDetailsExternal.centerYAnchor.constraint(equalTo: mailTitleLabel.centerYAnchor),
            mailDetailsExternal.leadingAnchor.constraint(
                greaterThanOrEqualTo: mailTitleLabel.trailingAnchor,
                constant: QwantUX.Spacing.s),
            mailDetailsExternal.trailingAnchor.constraint(
                equalTo: mailView.trailingAnchor,
                constant: -QwantUX.Spacing.m),
    ...
    override func updateViewDetails() {
        ...
        let showCounter = viewModel.globalETPIsEnabled && viewModel.isSiteETPEnabled
        localProtectionShieldCounterLabel.text = showCounter ? String(describing: viewModel.blockedTrackersCount) : nil
        ...
        let detailsHidden = !viewModel.isSiteETPEnabled || !viewModel.globalETPIsEnabled || viewModel.isSiteETPEnabling
        localProtectionDetailArrow.isHidden = detailsHidden
        localProtectionDetailsButton.isHidden = detailsHidden
    ...
    // MARK: - Button actions
    @objc
    private func didActivateTrackingProtection() {
...
extension QwantVIPMenuVC: MFMailComposeViewControllerDelegate {
