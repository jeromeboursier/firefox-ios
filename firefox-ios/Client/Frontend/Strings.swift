...
extension String {
    ...
    public struct QwantVIP {
        public static let ConnectionSecure = QwantString(key: "Qwant.VIP.ConnectionSecure")
        public static let ConnectionNotSecure = QwantString(key: "Qwant.VIP.ConnectionNotSecure")
        public static let LocalProtectionEnabledTitle = QwantString(key: "Qwant.VIP.LocalProtection.EnabledTitle")
        public static let LocalProtectionEnablingTitle = QwantString(key: "Qwant.VIP.LocalProtection.EnablingTitle")
        public static let LocalProtectionDisablingTitle = QwantString(key: "Qwant.VIP.LocalProtection.DisablingTitle")
        public static let LocalProtectionLoadingSubtitle = QwantString(key: "Qwant.VIP.LocalProtection.LoadingSubtitle")
        public static let LocalProtectionLongerLoadingSubtitle = QwantString(key: "Qwant.VIP.LocalProtection.LongerLoadingSubtitle")
        public static let LocalProtectionDisabledTitle = QwantString(key: "Qwant.VIP.LocalProtection.DisabledTitle")
        public static let LocalProtectionEnabledSubtitle = QwantString(key: "Qwant.VIP.LocalProtection.EnabledSubtitle")
        public static let LocalProtectionDisabledSubtitle = QwantString(key: "Qwant.VIP.LocalProtection.DisabledSubtitle")
        public static let BlockedItems = QwantString(key: "Qwant.VIP.LocalProtection.BlockedItems")
        public static let ProtectionLevel = QwantString(key: "Qwant.VIP.ProtectionLevel.Title")
        public static let StandardTitle = QwantString(key: "Qwant.VIP.ProtectionLevel.StandardTitle")
        public static let StandardDescription = QwantString(key: "Qwant.VIP.ProtectionLevel.StandardDescription")
        public static let StrictTitle = QwantString(key: "Qwant.VIP.ProtectionLevel.StrictTitle")
        public static let StrictDescription = QwantString(key: "Qwant.VIP.ProtectionLevel.StrictDescription")
        public static let StrictFooter = QwantString(key: "Qwant.VIP.ProtectionLevel.StrictFooter")
        public static let DisabledTitle = QwantString(key: "Qwant.VIP.ProtectionLevel.DisabledTitle")
        public static let DisabledDescription = QwantString(key: "Qwant.VIP.ProtectionLevel.DisabledDescription")
        public static let LastThirtyDays = QwantString(key: "Qwant.VIP.Statistics.LastThirtyDays")
        public static let ItemsBlocked = QwantString(key: "Qwant.VIP.Statistics.ItemsBlocked")
        public static let TimeSaved = QwantString(key: "Qwant.VIP.Statistics.TimeSaved")
        public static let SeeDetails = QwantString(key: "Qwant.VIP.Statistics.SeeDetails")
        public static let LocalProtection = QwantString(key: "Qwant.VIP.LocalProtection.ScreenTitle")
        public static let TrackersTitle = QwantString(key: "Qwant.VIP.LocalProtection.TrackersTitle")
        public static let DomainsTitle = QwantString(key: "Qwant.VIP.LocalProtection.DomainsTitle")
        public static let Statistics = QwantString(key: "Qwant.VIP.Statistics.ScreenTitle")
        public static let GlobalProtection = QwantString(key: "Qwant.VIP.GlobalProtection.ScreenTitle")
        public static let Help = QwantString(key: "Qwant.VIP.GlobalProtection.Help")
        public static let About = QwantString(key: "Qwant.VIP.GlobalProtection.About")
        public static let Experience = QwantString(key: "Qwant.VIP.GlobalProtection.Experience")
        public static let Inactive = QwantString(key: "Qwant.VIP.LocalProtection.Inactive")
        public static let OnDomain = QwantString(key: "Qwant.VIP.LocalProtection.OnDomain")
        public static let Information = QwantString(key: "Qwant.VIP.Information.Title")
        public static let Feedback = QwantString(key: "Qwant.VIP.Feedback.Title")
        public static let TrackersCookiesTitle = QwantString(key: "Qwant.VIP.LocalProtection.TrackersCookiesTitle")
        public static let EmptyListTrackersBlocked = QwantString(key: "Qwant.VIP.LocalProtection.EmptyListTrackersBlocked")
        public static let ReactivateProtection = QwantString(key: "Qwant.VIP.ProtectionLevel.Reactivate")
        public static let ReactivateStats = QwantString(key: "Qwant.VIP.Statistics.Reactivate")
        public static let DeactivateStats = QwantString(key: "Qwant.VIP.Statistics.Deactivate")
        public static let DeactivateStatsDetails = QwantString(key: "Qwant.VIP.Statistics.DeactivateDetails")
        public static let DeactivateStatsConfirm = QwantString(key: "Qwant.VIP.Statistics.Deactivate.Confirm")
        public static let DeactivateStatsCancel = QwantString(key: "Qwant.VIP.Statistics.Deactivate.Cancel")
        public static let DeactivatedForNow = QwantString(key: "Qwant.VIP.Statistics.DeactivateForNow")
        public static let DeleteStats = QwantString(key: "Qwant.VIP.Statistics.Delete")
        public static let JustActivated = QwantString(key: "Qwant.VIP.Statistics.JustActivated")
        public static let NothingToSee = QwantString(key: "Qwant.VIP.Statistics.Empty")
